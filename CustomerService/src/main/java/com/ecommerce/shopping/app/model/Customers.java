...
public class Customers {
	...
	@Column(name="firstname", nullable = false) //1
	private String firstname;
	
	@Column(name="lasttname", nullable = false) //2
	private String lastname;
	
	@Column(name="dateofbirth", nullable = false) //3
	private String dateofbirth;
	
	@Column(name="contactnumber", nullable = false) //4
	private String contactnumber;
	
	@Column(name="addressline1", nullable = false) //5
	private String addressLine1;
	
	@Column(name="addressline2", nullable = true) //6
	private String addressLine2;
	
	@Column(name="zipcode", nullable = false) //7
	...
	@Column(name="secretquestion", nullable = true) //10
	private String secretquestion;
	
	@Column(name="Secretquestionanswer", nullable = true) //11
	private String secretquestionanswer;
    
	@Column(name="customeremailid", nullable = false, unique = true) //12
	private String customeremailid;
	
	@Column(name="status", nullable = false) //13
